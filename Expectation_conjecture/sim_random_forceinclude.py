...
def calculate_multiple_expectations(num_vars, num_trials, max_order=4, specific_T=None):
    ...
    for i in range(num_trials):
        # Ensure ALL trials include T in both V and W
        force_include_T = True
...
df_specific.to_csv(f"random_combinations_results_T{specific_T}_force.csv", index=False)
print(f"\nResults for T={specific_T} saved to 'random_combinations_results_T{specific_T}_force.csv'")
